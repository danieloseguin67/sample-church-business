# Church Business Application - Build and Deploy Script
param(
    [string]$ImageName = "church-business-app",
    [string]$ContainerName = "church-business-container",
    [int]$Port = 8081,
    [switch]$SkipBuild,
    [switch]$CleanUp,
    [switch]$Help
...
if ($Help) {
    Write-Host "Church Business Application - Build and Deploy Script" -ForegroundColor Green
    Write-Host ""
    Write-Host "Usage: .\deploy.ps1 [OPTIONS]" -ForegroundColor Yellow
    Write-Host ""
    Write-Host "Options:" -ForegroundColor Yellow
    Write-Host "  -ImageName      Docker image name (default: church-business-app)"
    Write-Host "  -ContainerName  Docker container name (default: church-business-container)"
    Write-Host "  -Port           Host port to map to container port 80 (default: 8081)"
...
Write-Host "Church Business Application - Deploy" -ForegroundColor Green
